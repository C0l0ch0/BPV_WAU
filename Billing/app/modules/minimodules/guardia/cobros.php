...
<?php
  ...
  function getDataTableSACA(){
    ...
    $body = $body. "%</td></tr>";
    $body = $body. "<tr><td align=\"center\"> SAPAN </td><td align=\"right\">".number_format($r->SAPAN)."</td><td align=\"right\">".number_format($r2->SAPAN)."</td><td align=\"right\">  ".number_format((($r->SAPAN*100)/1));
    $body = $body. "%</td></tr>";
    return $body;
  }
  function getAccess(){
...
<div class="row-fluid">
				<div class="box span4" onTablet="span6" onDesktop="span4">
					...
					<div id="SAMEX" class="box-content">
					...
					<div id="SAPER" style="width: 400px; height: 250px;" class="box-content">
					...
					<div id="SAECU" style="width: 400px; height: 250px;" class="box-content">
...
<div class="row-fluid">
					...
					<div id="SANIC" style="width: 400px; height: 250px;" class="box-content">
					...
					<div id="SAPAN" style="width: 400px; height: 250px;" class="box-content">
...
*/
        ...
        var options1 = {
          ...
          vAxis: {minValue: 0},
          pointSize: 5,
		  chartArea:{left:50,top:40,width:'60px',height:'200px'},
          series:{
            0: {color: '#9EABB4'},
            1: {color: '#0fd43a'}
          }
