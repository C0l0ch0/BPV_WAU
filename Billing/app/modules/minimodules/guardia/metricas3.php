...
<div style="display:inline-block; align: left; margin-left: 5px;">
...
<div  class="CSSTableGenerator " style="display:inline-block; vertical-align: top;">
   ...
   <div style="display:inline-block;"></div>
	...
	<div class="box span4" onTablet="span4" onDesktop="span4">
		...
		<center>
		<div class="box-content">
			<div id="SAGUA" style="width: 400px; height: 250px; display:inline-block;"></div>
		</div>
		<center>
	</div><!--/span-->
...
*/
        ...
        data5.addColumn('number', 'Mismo dia, semana pasada');
