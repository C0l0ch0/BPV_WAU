			...
			<!-- begin row -->
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <form method="POST" action="http://<?=URL.DS;?>dashboard/notificaciones" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
								...
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4">Seleccione Plataforma :</label>
									<div class="col-md-6 col-sm-6">
										<select class="form-control" id="select-required" name="supera"  data-parsley-required="true">
										<option value="">-- Super Agregador --</option>
										<option value="per_david">SAPER</option>										
										<option value="mex_david">SAMEX</option>
										<option value="ecu_david">SAECU</option>										
										</select>
									</div>
								</div>								
								<div class="form-group">
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="table-basic-7">
						...
						echo"</tbody>";} else {echo"ingrese datos";};
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="data-table" class="table table-striped table-bordered">
									...
									where created_date_time >= DATE_SUB(now(),INTERVAL 1 HOUR) and sample_data like \"%product_id=$busca%\" order by
