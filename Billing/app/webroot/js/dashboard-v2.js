...
var handleDashboardGritterNotification = function(name,nameD) {
    $(window).load(function() {
        setTimeout(function() {
            $.gritter.add({
                title: 'Welcome back, '+nameD+'!',
                text: '',
                image: location.origin+'/Billing/app/webroot/img/users/'+name+'.jpg',
                sticky: true,
                time: '',
